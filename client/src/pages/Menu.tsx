...
const menuItems = [
  ...
  { id: 2, category: 'Biryani', name: 'Chicken Biryani (600g Box)', price: '₹129', desc: 'Aromatic basmati rice cooked with 2 tender chicken pieces, accompanied with fresh Onion Raita & Kathirikai gravy.', img: 'https://images.unsplash.com/photo-1631515243349-e0cb75fb8d3a?q=80&w=400&auto=format&fit=crop', badge: 'Popular' },
