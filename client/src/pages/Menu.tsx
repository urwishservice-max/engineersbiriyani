...
const menuItems = [
  { id: 1, category: 'Biryani', name: 'Special Chicken Biryani (1200g)', price: '₹250', desc: 'Aromatic basmati rice cooked with 3 to 4 tender chicken pieces, authentic spices, and served with Bread Halwa, Onion Raita & Kathirikai.', img: 'https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?q=80&w=400&auto=format&fit=crop', badge: 'Bestseller' },
  { id: 2, category: 'Biryani', name: 'Chicken Biryani (600g Box)', price: '₹130', desc: 'Aromatic basmati rice cooked with 2 tender chicken pieces, accompanied with fresh Onion Raita & Kathirikai gravy.', img: 'https://images.unsplash.com/photo-1631515243349-e0cb75fb8d3a?q=80&w=400&auto=format&fit=crop', badge: 'Popular' },
  ...
  { id: 4, category: 'Sides', name: 'Kathirikai (Brinjal Curry)', price: 'Included', desc: 'Traditional authentic South Indian tangy brinjal gravy. The perfect accompaniment.', img: 'https://images.unsplash.com/photo-1585937421612-70a008356fbe?w=400&q=80' },
];
