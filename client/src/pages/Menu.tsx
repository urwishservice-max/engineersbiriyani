...
const menuItems = [
  { id: 1, category: 'Biryani', name: 'Special Chicken Biryani (1200g)', price: '₹239', desc: 'Aromatic basmati rice cooked with 3 to 4 tender chicken pieces, authentic spices, and served with Bread Halwa, Onion Raita & Kathrika.', img: 'https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?q=80&w=400&auto=format&fit=crop', badge: 'Bestseller' },
